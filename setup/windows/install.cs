...
class Installer {
    static void Main() {
        Console.Title = "LastDisc Installer";
        Console.WriteLine("====================================================");
        Console.WriteLine("            LastDisc Watcher Installer              ");
        Console.WriteLine("====================================================");
        Console.WriteLine();
        ...
        try {
            ...
            if (!File.Exists(installPs1)) {
                Console.WriteLine("Error: install.ps1 not found in current directory.");
                Console.WriteLine("Expected path: " + installPs1);
                Console.ReadLine();
                return;
            }

            Console.WriteLine("Running installation script...");
            ...
            using (Process p = Process.Start(psi)) {
                ...
                if (p.ExitCode == 0) {
                    ...
                    Console.WriteLine("Starting watcher task...");
                    ...
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Installation failed with exit code " + p.ExitCode);
                    Console.ResetColor();
                }
            }
        } catch (Exception ex) {
